...
@section('content')
    ...
    <main>
        <div class="container">
            <div class="row pb-5" id="basket_content">
                @if($basket->count() == 0)
                    <div class="col text-center">
                ...
                @else
                <div class="col">
                    <table id="example114" class="table table-striped">
                        <thead>
                        <tr>
                            <th>Изображение</th>
                        ...
                        <tr book_id="{{$item->book->id}}">
                                <td style=" text-align: center;"> <img src="{{'storage/' . $item->book->prev_img}}" width="50"></td>
                                ...
                                <td><span class="sum"
                                          book_id="{{$item->book->id}}">{{$item->quantity * $item->book->price}}</span></td>
                                <td><button type="submit"
                ...
                <div class="pt-2">
                    <p>Общая стоимость: <strong>{{$basketSum}}</strong> руб.</p>
                </div>
